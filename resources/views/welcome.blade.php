<x-layouts.app>
    ...
    <x-split-info image="img/fondos/mision.png" imageAlt="Auditorio y conferencia" imagePosition="right" color="#19355C"
        objectPos="[60%_60%]" icon="img/icons/docentes.png" iconClass="h-16 md:h-22 lg:h-28 w-auto"
