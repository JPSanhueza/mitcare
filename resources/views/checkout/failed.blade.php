            ...
            <div class="shrink-0 mt-1">
                <svg class="w-8 h-8 text-rose-600" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    <path fill-rule="evenodd"
                        d="M12 2.25a9.75 9.75 0 1 0 9.75 9.75A9.76 9.76 0 0 0 12 2.25Zm0 5.25a.75.75 0 0 1 .75.75v3.75a.75.75 0 0 1-1.5 0V8.25A.75.75 0 0 1 12 7.5Zm0 8.25a1.125 1.125 0 1 1 0 2.25 1.125 1.125 0 0 1 0-2.25Z"
                        clip-rule="evenodd" />
                </svg>
            </div>
            <div>
                ...
                <div class="rounded-xl border border-gray-200 bg-white">
                    ...
                    <ul class="p-4 space-y-2 text-sm text-gray-700 list-disc ml-5">
                        ...
                        <li>Si el problema persiste, contáctanos en
                            <a href="mailto:{{ $supportEmail }}" class="text-[#19355C] underline">{{ $supportEmail
                                }}</a>.
                        </li>
                        <details class="mt-2">
                            ...
                            <ul class="list-disc ms-6 mt-2 text-sm text-amber-900">
                                <h2 class="text-base sm:text-lg font-semibold">
                                    Tu pago podría estar aprobado, pero la transacción figura como “{{ $niceStatus }}”.
                                </h2>

                                <p class="text-sm sm:text-base leading-relaxed">
                                    Es posible que tengamos un problema al confirmar la transacción en el sistema. Si
                                    realizaste el pago
                                    con
                                    éxito
                                    en
                                    Transbank, por favor sigue estos pasos para que podamos validar manualmente tu
                                    compra.
                                </p>
                                ...
                                <ol class="list-decimal ms-5 space-y-2 text-sm sm:text-base">
                                    <li>
                                        Escribe un correo a
                                        <a href="mailto:{{ $supportEmail }}" class="underline font-medium">{{
                                            $supportEmail
                                            }}</a>.
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        @else
                                        <span>(formato: <code
                                                class="px-1 py-0.5 bg-amber-100 rounded">ORD-XXXXXX</code>)</span>
                                        @endif
                                ...
                                <li>No intentes pagar de nuevo sin confirmar con soporte para evitar cargos duplicados.
                                </li>
                            </ul>
                        </details>
                    </ul>
